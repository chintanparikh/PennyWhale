...
# Insider holdings
Intent.create(name: 'Insider holdings', code: "yahoo_key_stats('insider holdings')")
match_phrases_to_intent(['insider holdings', '13f insider holdings', '13f insider'], intent)

# Institutional Holdings
Intent.create(name: 'Institutional Holdings', code: "yahoo_key_stats('institutional holdings')")
