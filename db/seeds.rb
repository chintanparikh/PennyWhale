...
# Ask (and realtime)
Intent.create(name: 'Ask', code: 'realtime_pull_from_yahoo("b2", "a0")')
...
# Bid
Intent.create(name: 'Bid', code: 'realtime_pull_from_yahoo("b3", "b0")')
...
# Days Range + realtime
Intent.create(name: 'Days Range', code: 'realtime_pull_from_yahoo("m2", "m0")')
match_phrases_to_intent(["day's range", 'days range', 'range', 'todays range'], intent)

# Days Value Change + realtime
Intent.create(name: 'Days Value Change', code: 'realtime_pull_from_yahoo("w4", "w1")')
...
Intent.create(name: 'Market Capitalization', code: 'realtime_pull_from_yahoo("j3", "j1")')
...
# PE Ratio
Intent.create(name: 'PE Ratio', code: 'realtime_pull_from_yahoo("r2", "r0")')
